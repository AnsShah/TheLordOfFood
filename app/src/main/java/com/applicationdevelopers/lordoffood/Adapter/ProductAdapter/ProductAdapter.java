...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> implements Filterable {
    ...
    Snackbar snackbar;
    int pos=0;
    public ProductAdapter(Context context, List<ProductModel> productmodels,RecyclerView recyclerView) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recipe_category_list_row,parent,false);
